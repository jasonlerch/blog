...
draft: true
categories: [R]
bibliography: /Users/jason/Dropbox/zotero_library.bib
format:
  html:
    code-fold: true
...
This equation is implemented as a general additive model via the *mgcv* packages in R [@wood_2011]. P-values for the smooth term $f_2(\text{age}_{i,t}, \text{Genotype}_i)$ are then then computed via _summary.gam_ and corrected for multiple comparisons using the False Discovery Rate (FDR) [@benjamini.hochberg_1995].
